...
time_origin_julien=datenum(time_origin);
radar.time=radar.time+radar.time_origin-time_origin_julien;
model.time=model.time/(60*60*24)+model.time_origin-time_origin_julien;
