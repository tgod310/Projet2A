...
for i=1:length(model.time)
    model.interp_U(:,:,i)=interp2(model.lat,model.lon,model.U(:,:,1,i),radar.lat,radar.lon,'cubic');
    model.interp_V(:,:,i)=interp2(model.lat,model.lon,model.V(:,:,1,i),radar.lat,radar.lon,'cubic');
end
