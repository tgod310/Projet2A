function [model,drifter,shared] = shared_time(model,drifter,shared)
...
[shared.time_0,shared.time_end]=crossed_data(drifter.time_min,drifter.time_max,model.time_min,model.time_max); % recuperation du premier temps et dernier temps de la plage commune
