...
%return 4 corners of shared space : shared.lat_0,
%shared.lat_end,shared.lon_0,shared.lon_end, and a grid of shared space based on data1
...
% Search of common data range with longitude and latitude
...
% grid common based on grid data1
